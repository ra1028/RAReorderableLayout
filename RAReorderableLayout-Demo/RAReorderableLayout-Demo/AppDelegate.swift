...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.urlForResource("RAReorderableLayout_Demo", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = try! self.applicationDocumentsDirectory.appendingPathComponent("RAReorderableLayout_Demo.sqlite")
